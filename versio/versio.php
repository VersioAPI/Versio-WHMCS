...
function versio_RegisterDomain($params)
{
	...
	$versio->setApi_login($username, $password);
    ...
    $contactDetails['street'] = preg_replace('/^[0-9]+$/', '', $params["address1"]);
	$contactDetails['number'] = preg_replace('/\D/', '', $params["address1"]);
...
function versio_SaveContactDetails($params)
{
    ...
    $contactDetails['street'] = preg_replace('/[0-9]+/', '', $params['contactdetails']['Registrant']['Address 1']);
	$contactDetails['number'] = preg_replace('/\D/', '', $params['contactdetails']['Registrant']['Address 1']);
